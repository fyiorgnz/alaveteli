...
module MailHandler
  ...
  def normalise_content_type(content_type)
    ...
    case content_type
    when 'application/excel', 'application/msexcel', 'application/x-ms-excel'
      'application/vnd.ms-excel'
    when 'application/mspowerpoint', 'application/x-ms-powerpoint'
      'application/vnd.ms-powerpoint'
    when 'application/msword', 'application/x-ms-word'
      'application/vnd.ms-word'
    when 'application/x-zip-compressed'
      'application/zip'
    when 'application/acrobat', 'document/pdf'
